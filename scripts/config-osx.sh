setup_osx() {
  ...
  cp "./macos/com.openssh.ssh-agent.plist" "$HOME/Library/LaunchAgents/"
  chown "$USER" "$HOME/Library/LaunchAgents/com.openssh.ssh-agent.plist"
  chmod 644 "$HOME/Library/LaunchAgents/com.openssh.ssh-agent.plist"
  ...
  launchctl bootstrap gui/$(id -u) "$HOME/Library/LaunchAgents/com.openssh.ssh-agent.plist"
